              ...
              {[
                ...
                <>
                  ...
                  <div className="relative py-2">
                    <button
                      onClick={() =>
                        setIsDesktopShowcaseOpen(!isDesktopShowcaseOpen)
                      }
                ...
                {[
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      style: (
                        <motion.div
                          animate={{ rotate: isShowcaseOpen ? 180 : 0 }}
                        >
                          <ChevronDown size={32} />
                        </motion.div>
                      ),
                          ...
                          >
                            {item.subItems.map((sub) => (
                              <button
                                ...
                                className="flex cursor-target cursor-none items-center justify-between text-xl md:text-2xl font-lyrae text-zinc-400 hover:text-current transition-colors"
                              >
                                <span>{sub.name}</span>
                                {sub.icon}
                              </button>
              ...
              <div className="flex-none mt-auto">
                ...
                <div className="flex flex-wrap gap-4 font-mono font-bold mb-8">
                  {[
                    ...
                    {
                      name: "Email",
                      url: "mailto:anantafirdaus14@gmail.com",
                      icon: <Mail size={18} />,
                    },
                  ].map((link) => (
                    <motion.a
