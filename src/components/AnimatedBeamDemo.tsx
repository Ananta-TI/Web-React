...
export function AnimatedBeamDemo() {
  ...
  const getIconFill = (isDarkMode: boolean, color: string) =>
  ...
  <Icons.js isDarkMode={isDarkMode} />
    ...
    ${isDarkMode ? "bg-zinc-800" : "bg-zinc-200"}`}
          >
            <span
              className={`whitespace-pre-wrap bg-clip-text text-center text-4xl sm:text-6xl lg:text-8xl font-semibold font-lyrae leading-tight sm:leading-none text-transparent      ${isDarkMode
...
const Icons = {
  ...
  <svg
    stroke="currentColor"
    fill={isDarkMode ? "#ffA828" : "#000"}
    strokeWidth="0"
    viewBox="0 0 24 24"
className={`h-20 w-20 cursor-target hover:scale-110 transition-transform duration-200 ${
  isDarkMode
    ? "drop-shadow-[0_0_30px_#ffA828] hover:drop-shadow-[0_0_25px_#ffA828]"
    : "hover:drop-shadow-[0_0_25px_#ffff]"
}`}
  ...
  html: ({ isDarkMode }: { isDarkMode: boolean }) => (
    <svg
      stroke="currentColor"
      fill={isDarkMode ?"#E34C26 ": "#000"}
      strokeWidth="0"
      viewBox="0 0 24 24"
className={`h-20 w-20 cursor-target hover:scale-110 transition-transform duration-200 ${
  isDarkMode
    ? "drop-shadow-[0_0_30px_#E34C26] hover:drop-shadow-[0_0_25px_#E34C26]"
    : "hover:drop-shadow-[0_0_25px_#ffff]"
}`}      
      xmlns="http://www.w3.org/2000/svg"
    >
  ...
  tailwind: ({ isDarkMode }: { isDarkMode: boolean }) => (
    <svg
      stroke="currentColor"
      fill={isDarkMode ? "#05DBE9" : "#000"} 
      strokeWidth="0"
      viewBox="0 0 24 24"
className={`h-20 w-20 cursor-target hover:scale-110 transition-transform duration-200 ${
  isDarkMode
    ? "drop-shadow-[0_0_30px_#05DBE9] hover:drop-shadow-[0_0_25px_#05DBE9]"
    : "hover:drop-shadow-[0_0_25px_#ffff]"
}`}      
  xmlns="http://www.w3.org/2000/svg"
    >
  ...
  css: ({ isDarkMode }: { isDarkMode: boolean }) => (
    <svg
      stroke="currentColor"
      fill={isDarkMode ? "#33B3F1" : "#000"}
      strokeWidth="0"
      viewBox="0 0 24 24"
className={`h-20 w-20 cursor-target hover:scale-110 transition-transform duration-200 ${
  isDarkMode
    ? "drop-shadow-[0_0_30px_#33B3F1] hover:drop-shadow-[0_0_25px_#33B3F1]"
    : "hover:drop-shadow-[0_0_25px_#ffff]"
}`}      xmlns="http://www.w3.org/2000/svg"
    >
  ...
  react: ({ isDarkMode }: { isDarkMode: boolean }) => (
    <svg
      stroke="currentColor"
      fill={isDarkMode ? "#61DBFB" : "#000"}
      strokeWidth="0"
      viewBox="0 0 24 24"
className={`h-20 w-20 cursor-target hover:scale-110 transition-transform duration-200 ${
  isDarkMode
    ? "drop-shadow-[0_0_30px_#61DBFB] hover:drop-shadow-[0_0_25px_#61DBFB]"
    : "hover:drop-shadow-[0_0_25px_#ffff]"
}`}      xmlns="http://www.w3.org/2000/svg"
    >
  ...
  laravel: ({ isDarkMode }: { isDarkMode: boolean }) => (
    <svg
      stroke="currentColor"
      fill={isDarkMode ? "#F55247" : "#000"}
      strokeWidth="0"
      viewBox="0 0 34 24"
className={`h-20 w-20 cursor-target hover:scale-110 transition-transform duration-200 ${
  isDarkMode
    ? "drop-shadow-[0_0_30px_#F55247] hover:drop-shadow-[0_0_25px_#F55247]"
    : "hover:drop-shadow-[0_0_25px_#ffff]"
}`}      xmlns="http://www.w3.org/2000/svg"
    >
      <title>laravel</title>
