...
return (
  ...
  >
    {/* Background Particles: Ubah z-20 ke z-0 */}
    <Particles
      ...
      sizeRandomness={5.2}
      cameraDistance={25}
      className="absolute inset-0 z-0 w-full h-full" // Tetap z-0 agar tidak menimpa scroll
    />
    ...
    >
      ...
      <motion.div
        ...
        transition={{ delay: 3.2, duration: 1 }} // Naikkan ke 3.2 jika ingin teks muncul SETELAH logo selesai (1s delay + durasi gambar)
        className="mt-12"
      >
